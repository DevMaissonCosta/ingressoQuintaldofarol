# ingressoQuintaldofarol
Backend em Spring Boot para venda automatizada de ingressos via WhatsApp - Bar Quintal do Farol
...
O cliente envia uma mensagem no WhatsApp do bar manifestando interesse em comprar um ingresso.
O sistema identifica o lote de ingressos disponivel no momento e responde automaticamente.
E gerada uma cobranca (PIX ou cartao) atraves do Mercado Pago.
Apos a confirmacao do pagamento, o sistema gera um ingresso com codigo unico.
O ingresso e enviado de volta ao cliente pelo WhatsApp.
Tecnologias
Java
Spring Boot
